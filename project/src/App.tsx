...
//   const noLayoutRoutes = ['/admin', '/login','/register', '/register-course', '/users', '/lecturer','edit-lecturer','/admin-courses','/lecturer-courses', '/loggs','/timetable','/verify-token','/cleartoken','/','/admin-create','/adminlist','/editadmin','/Landingpage','/Submitted-exam','/answers/:submissionId','/studentlogin','/adminlogin', '/instructions'];
...
import EditAdminModal from './components/admin/EditAdminModal.tsx';
import LandingPage from './pages/LandingPage.tsx';
import Instructions from './pages/Instructions'; // Omit .tsx extension
import JoinLogin from './pages/JoinLogin.tsx';
import LecturerSubmissions from './components/Lecturer/LecturerSubmission.tsx';
import ViewExam from './components/Lecturer/ViewExam.tsx';
import AdminLogin from './pages/AdminLogin.tsx';
        ...
        {isLayoutVisible ? (
          <div className="min-h-screen bg-[linear-gradient(to_bottom_right,_#0b1e1b,_#496863)]">
            ...
            <Suspense fallback={<LoadingScreen />}>
              <Routes>
                ...
                <Route path="/view/:roomId" element={<Viewer />} />
                <Route path="/proctoring" element={<ProctoringPage />} />
                {/* Removed /instructions from here to avoid conflict */}
                <Route path="/admin" element={<AdminDashboard />} />
                <Route path="/lecturer" element={<LecturerDashboard />} />
                <Route path="/register" element={<RegForm />} />
                <Route path="/register-course" element={<RegCourse />} />
          ...
          <Suspense fallback={<LoadingScreen />}>
            <Routes>
              ...
              <Route path="/view/:roomId" element={<Viewer />} />
              <Route path="/proctoring" element={<ProctoringPage />} />
              <Route path="/instructions" element={<Instructions />} /> {/* Only here */}
              <Route path="/admin" element={<AdminDashboard />} />
              <Route path="/lecturer" element={<LecturerDashboard />} />
              <Route path="/register" element={<RegForm />} />
              <Route path="/register-course" element={<RegCourse />} />
