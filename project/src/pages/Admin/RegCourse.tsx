...
//       <SidebarProvider1>
//       <div className={`flex flex-1 ${isMobileMenuOpen ? 'overflow-hidden' : ''}`}>
...
//             <>
//               <div
//                 className={`fixed inset-0 bg-black bg-opacity-30 z-10 ${isMobileMenuOpen ? 'block' : 'hidden'}`}
